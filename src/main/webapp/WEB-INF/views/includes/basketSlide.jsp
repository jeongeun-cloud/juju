...
var id = document.getElementById("hiddenId").value;
   ...
   function draw(jsonData) { // JSONdata 에 xml 형태의 JSON이 들어온다 왜? 
      ...
      for(var i=0; i<jsonData.length-1; i++) {
         ...
         $basketList.append("<div id='basketImg'><img src='/resources/upload/"+jsonData[i].idNo+"/"+jsonData[i].itemImg1+"' style= \"width:100px; border: 3px; float:left; margin-left: 10px; margin-top:10px; margin-bottom:30px; \" /></div>");
